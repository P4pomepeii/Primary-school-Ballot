  ...
  return (
    <main style={{ maxWidth: 760, margin: "0 auto", padding: "48px 20px 96px" }}>
      <header style={{ marginBottom: 32 }}>
        <a href="/" style={{ fontSize: 14 }}>← Compare two schools</a>
        <h1 style={{ fontSize: 28, marginBottom: 6 }}>School-Fit Copilot</h1>
        <p role="note" style={{ padding: 12, background: "#fff4dd", fontSize: 14 }}>
          Legacy discovery demo. All school records and admission figures are fictional;
          journeys use a fixed demo address. These results are not personal admission advice.
        </p>
